                ...
                @if ($item->sub_header == 'top_header')
                    <div class="sab_banner_text">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('lang.events') }}</li>
                        </ul>
                    </div>
                @endif
                @endif
                            ...
                            <div class="event_fig listing bg_gray margin30">
                                ...
                                <div class="event_text">
                                    <h5>{{__($item->{$lang.'_title'})}} @if ($item->eventorupevent == 1)
                                        <b style="color: rgb(250, 41, 41)"> {!!__('lang.upcoming events')!!}</b>
                                    @endif</h5>
                                ...
                                <p>{!!__(str_limit($item->{$lang.'_subtitle'},300))!!}</p>
                                    <a class="more_btn" href="details/{{$item->id}}">{{ __('lang.more') }} <i class="fa fa-angle-right"></i></a>
                                </div>
                            </div>
                            @endif
                        @endforeach
