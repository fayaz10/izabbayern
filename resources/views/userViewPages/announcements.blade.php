  ...
  <div class="sab_banner theme_overlay">
        <div class="container">
                @foreach ($announcements as $item)
                    @if ($item->header == 'announce_header')
                      @if ($item->sub_header == 'top_header')
                        <div class="sab_banner_text">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ __('lang.announcements') }}</li>
                        ...
                        <div class="event_fig listing bg_gray margin30 row">
                            <div class="col-md-8">
                             <div class="event_text" style="text-align: right;float: left;">
                                 <h5> @if ($item->eventorupevent == 1)<b style="color: rgb(250, 41, 41)"> {!!__('lang.upcoming events')!!}</b> @endif{{__($item->{$lang.'_title'})}}</h5>
                                 <ul class="blog_meta">
                                     @if ($item->timing != null)
                                         <li><a href="#"><i class="fa icon-time-1"></i>{{__($item->timing)}}</a></li>
                                     @endif
                                     @if ($item->location != null)
                                         <li><a href="#"><i class="fa  icon-pin-1"></i>{{__($item->fa_location)}}</a></li>
                                     @endif
                                 </ul>
                            ...
                            <div class="event_fig listing bg_gray margin30">
                                ...
                                <div class="event_text">
                                    <h5>{{__($item->{$lang.'_title'})}} @if ($item->eventorupevent == 1)
                                        <b style="color: rgb(250, 41, 41)"> {!!__('Up Comming Event')!!}</b>
                                    @endif</h5>
                                    ...
                                    <ul class="blog_meta">
                                        ...
                                        <li><a href="#"><i class="fa icon-time-1"></i>{{__($item->timing)}}</a></li>
                                            @endif
                                        @if ($item->location != null)
                                        <li><a href="#"><i class="fa  icon-pin-1"></i>{{__($item->location)}}</a></li>
                                            @endif
