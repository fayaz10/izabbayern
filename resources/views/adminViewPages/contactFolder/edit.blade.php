                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="/admin/contact"> <button type="submit" class="btn btn-danger btn-sm">
                                <i class="fa fa-dot-circle-o"></i> Go Back
                            </button></a>
                            <strong>Update contact</strong> Elements
                        </div>
                        <div class="card-body card-block">
                            <form  action="{{url('admin/contact',$contact->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                 <div class="row form-group">
                                    <label for="status">Top Header</label>
                                    <select name="header" value="{{$contact->header}}" id="header" class="form-control">
                                ...
                                <div class="row form-group">
                                    <div class="col-12 col-md-6"><label for="menu title">title( Farsi) </label>
                                        <input type="text"  value="{{$contact->fa_title}}" id="fa_title" name="fa_title" placeholder="Title" class="form-control">
                                    ...
                                    <div class="col-12 col-md-6"><label for="menu title">subtitle (Farsi)</label>
                                        <input type="text" id="subtitle"  value="{{$contact->fa_subtitle}}" name="fa_subtitle" placeholder="Subtitle" class="form-control">
                                ...
                                <div class="row form-group">
                                    <div class="col-12 col-md-6"><label for="menu title">title( Pashtow) </label>
                                        <input type="text" id="ps_title" value="{{$contact->ps_title}}" name="ps_title" placeholder="Title" class="form-control">
                                    ...
                                    <div class="col-12 col-md-6"><label for="menu title">subtitle (Pashtow)</label>
                                        <input type="text" id="ps_subtitle"  value="{{$contact->ps_subtitle}}" name="ps_subtitle" placeholder="Subtitle" class="form-control">
                                        <small class="form-text text-muted">Write subtitle here.</small>
                                    </div>
                                </div> <hr>
                                ...
                                <div class="row form-group">
                                    <div class="col-12 col-md-6"><label for="menu title">title (German)</label>
                                        <input type="text" id="de_title" name="de_title"  value="{{$contact->de_title}}" placeholder="contact title" class="form-control">
                                    ...
                                    <div class="col-12 col-md-6"><label for="menu title">subtitle (German)</label>
                                        <input type="text" id="de_subtitle" value="{{$contact->de_subtitle}}" name="de_subtitle" placeholder="contact subtitle" class="form-control">
                                ...
                                <div class="row form-group">
                                    <div class="col-12 col-md-6"><label for="menu title">title (English)</label>
                                        <input type="text" id="en_title" name="en_title"  value="{{$contact->en_title}}" placeholder="contact title" class="form-control">
                                        <small class="form-text text-muted">Write contact name here.</small>
                                    </div>
                                    <div class="col-12 col-md-6"><label for="menu title">subtitle (English)</label>
                                        <input type="text" id="en_subtitle" value="{{$contact->en_subtitle}}" name="en_subtitle" placeholder="contact subtitle" class="form-control">
                                        <small class="form-text text-muted">Write contact Subtitle here.</small>
                                    </div>
                                </div><hr>
                                <div class="row form-group">
                                    <div class="col-12 col-md-6"><label for="menu title"> Address (Farsi)</label>
                                        <input type="text" id="fa_address"  value="{{$contact->fa_address}}" name="fa_address" placeholder="Address" class="form-control">
                                    ...
                                    <div class="col-12 col-md-6"><label for="menu title"> Address (Pashtwo)</label>
                                        <input type="text" id="ps_address"  value="{{$contact->ps_address}}" name="ps_address" placeholder="Address" class="form-control">
                                        <small class="form-text text-muted">Write Address here.</small>
                                    </div>
                                </div><hr>
                                <div class="row form-group">
                                    <div class="col-12 col-md-6"><label for="menu title">address (German)</label>
                                        <input type="text" id="en_address" value="{{$contact->de_address}}" name="de_address" placeholder=" address" class="form-control">
                                        <small class="form-text text-muted">Write  address here.</small>
                                    </div>
                                    <div class="col-12 col-md-6"><label for="menu title">address (English)</label>
                                        <input type="text" id="en_address"  value="{{$contact->en_address}}" name="en_address" placeholder=" address" class="form-control">
                                        <small class="form-text text-muted">Write  address here.</small>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-12 col-md-4"><label for="menu title">contact phone</label>
                                        <input type="text" id="phone" name="phone1"  value="{{$contact->phone1}}" placeholder="phone" class="form-control">
                                    ...
                                    <div class="col-12 col-md-4"><label for="menu title">phone two (Optional)</label>
                                        <input type="text" id="phone" name="phone2"  value="{{$contact->phone2}}" placeholder="phone 2" class="form-control">
                                    ...
                                    <div class="col-12 col-md-4"><label for="menu title"> phone three (Optional)</label>
                                        <input type="text" id="phone" name="phone3"  value="{{$contact->phone3}}" placeholder="phone 3" class="form-control">
                                ...
                                <div class="row form-group">
                                    <div class="col-12 col-md-4"><label for="email">contact email</label>
                                        <input type="email" id="email1" name="email1"  value="{{$contact->email1}}" placeholder="email" class="form-control">
                                    ...
                                    <div class="col-12 col-md-4"><label for="menu title">email two (Optional)</label>
                                        <input type="email" id="email2" name="email2" value="{{$contact->email2}}" placeholder="email 2" class="form-control">
                                    ...
                                    <div class="col-12 col-md-4"><label for="menu title"> email three (Optional)</label>
                                        <input type="email" id="email3" name="email3" value="{{$contact->email3}}" placeholder="email 3" class="form-control">
